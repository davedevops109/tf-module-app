    ...
    "Statement": [
      {
       ...
       "Action" : [
        ...
        "Resource" : [
          "arn:aws:ssm:us-east-1:822823079630:parameter/${var.env}.${var.component}*",
          "arn:aws:ssm:us-east-1:822823079630:parameter/nexus*",
          "arn:aws:ssm:us-east-1:822823079630:parameter/${var.env}.docdb*",
          "arn:aws:ssm:us-east-1:822823079630:parameter/${var.env}.elasticache*",
          "arn:aws:ssm:us-east-1:822823079630:parameter/${var.env}.rds*",
          "arn:aws:ssm:us-east-1:822823079630:parameter/${var.env}.rabbitmq*"
        ]
    },
    {
       "Sid" : "VisualEditor1",
...
resource "aws_lb_listener_rule" "backend_rule" {
  ...
  condition {
    host_header {
      values = ["${var.component}-${var.env}.davedevops.tech"]
    }
  }
}
